...
public class AdminBean {
	/**
	 * @see this is the model class for admin, Here I declared all required
	 *      attribute
	...
	public AdminBean(String name, String email, String password, int admin) {
		super();
		this.name = name;
		this.email = email;
		this.password = password;
	...
	public AdminBean(int id, String name, String email, String password, int admin) {
		super();
		this.id = id;
		this.name = name;
		this.email = email;
